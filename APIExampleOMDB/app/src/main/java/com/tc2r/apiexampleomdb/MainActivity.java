...
import com.tc2r.apiexampleomdb.adapters.MovieDataAdapter;
import com.tc2r.apiexampleomdb.custom.CustomRecyclerViewScrollListener;
import com.tc2r.apiexampleomdb.data.MovieData;
import com.tc2r.apiexampleomdb.task.OMDBDataAPITask;
...
public class MainActivity extends AppCompatActivity {
	...
	OMDBDataAPITask omdbDataAPITask;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		scrollListener = new CustomRecyclerViewScrollListener(layoutManager) {
			...
			public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
				if (lastPage > page) {
					omdbDataAPITask = new OMDBDataAPITask(MainActivity.this, lastPage + 1);
					setPage(lastPage);
		...
		searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			private void doSearch(String tmpQuery) {
				...
				omdbDataAPITask = new
								...
								OMDBDataAPITask(MainActivity.this, 1);
